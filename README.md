...
4. You need just basic understanding of Dynamo and Revit although you should have developed your skills in Python and Navisworks to an intermediate level before you can customize the workflow to suite your business.
5. In general, anyone can utilize this workflow in their business because it's just a matter of few click to make the trick happen
6. If need be you can have a walkthrough on some Python Data Analytics liibrary utilized in the process. Some of which are; Pandas, Numpy, Itertools, 
